...
-- Last modification date: 2023-06-09 07:04:43.05
...
CREATE TABLE Composer (
    id int  NOT NULL,
    nama_composer varchar(50)  NOT NULL,
    CONSTRAINT Composer_pk PRIMARY KEY (id)
);

-- Table: Composer_Lagu
CREATE TABLE Composer_Lagu (
    Composer_id int  NOT NULL,
    Lagu_id int  NOT NULL,
    CONSTRAINT Composer_Lagu_pk PRIMARY KEY (Composer_id,Lagu_id)
);
...
-- Reference: Composer_Lagu_Composer (table: Composer_Lagu)
ALTER TABLE Composer_Lagu ADD CONSTRAINT Composer_Lagu_Composer
...
-- Reference: Composer_Lagu_Lagu (table: Composer_Lagu)
ALTER TABLE Composer_Lagu ADD CONSTRAINT Composer_Lagu_Lagu
    FOREIGN KEY (Lagu_id)
    REFERENCES Lagu (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: Transaksi_metode_pembayaran (table: Transaksi)
ALTER TABLE Transaksi ADD CONSTRAINT Transaksi_metode_pembayaran
