-- Menampilkan 20 nama depan dan nama belakang sebagai nama pelanggan dengan provinsi pelanggan adalah 'Oklahoma' diurutkan berdasarkan jumlah transaksi. Jika ada jumlah transaksi yang sama, urutkan berdasarkan abjad nama pelanggan
